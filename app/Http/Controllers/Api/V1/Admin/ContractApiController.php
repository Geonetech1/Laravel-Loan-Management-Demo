...
class ContractApiController extends Controller
{
    ...
    public function index()
    {
        ...
        return new ContractResource(Contract::with(['owner', 'status', 'analyst', 'legal', 'nda', 'comment'])->get());
    }
    ...
    public function show(Contract $contract)
    {
        ...
        return new ContractResource($contract->load(['owner', 'status', 'analyst', 'legal', 'nda', 'comment']));
    }
