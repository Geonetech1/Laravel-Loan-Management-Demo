            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="table-responsive">
                        <table class=" table table-bordered table-striped table-hover datatable datatable-contractComments">
                            <thead>
                                <tr>
                                    <th width="10">
                                    ...
                                    <th>
                                        {{ trans('cruds.comment.fields.contract') }}
                                    </th>
                                    <th>
...
@endcan
  ...
  let table = $('.datatable-contractComments:not(.ajaxTable)').DataTable({ buttons: dtButtons })
