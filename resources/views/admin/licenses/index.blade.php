                        ...
                        <table class=" table table-bordered table-striped table-hover datatable datatable-License">
                            <thead>
                                <tr>
                                    ...
                                    <th>
                                        {{ trans('cruds.license.fields.license') }}
                                    </th>
                                    <th>
                                        {{ trans('cruds.license.fields.verified') }}
                                    </th>
                                    <th>
                                        &nbsp;
                                    </th>
                            ...
                            <tbody>
                                @foreach($licenses as $key => $license)
                                    <tr data-entry-id="{{ $license->id }}">
                                        ...
                                        <td>
                                            @if($license->license)
                                                <a href="{{ $license->license->getUrl() }}" target="_blank">
                                                    {{ trans('global.view_file') }}
                                                </a>
                                            @endif
                                        </td>
                                        <td>
                                            <span style="display:none">{{ $license->verified ?? '' }}</span>
                                            <input type="checkbox" disabled="disabled" {{ $license->verified ? 'checked' : '' }}>
                                        </td>
                                        <td>
                                            @can('license_show')
...
@endcan
  ...
  let table = $('.datatable-License:not(.ajaxTable)').DataTable({ buttons: dtButtons })
